...
namespace ControlApp.Infra.Data.Migrations
{
    ...
    [Migration("20250131170900_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ControlApp.Domain.Entities.Trajeto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ControlApp.Domain.Entities.Localizacao", b =>
                {
                    b.HasOne("Ponto", "Ponto")
                        .WithMany("Localizacoes")
                        .HasForeignKey("PontoId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("ControlApp.Domain.Entities.Trajeto", "Trajeto")
                        .WithMany("Localizacoes")
